...
const RecentActivity: React.FC<RecentActivityProps> = ({ total, unusual }) => {
  return (
    <div className="border border-[#4A4A4A] rounded-md overflow-hidden bg-white h-full shadow-sm hover:shadow-md transition-shadow duration-200">
      <div className="font-serif text-sm font-bold text-[#242424] px-4 py-2 border-b border-[#4A4A4A] bg-[#F8F8F6]">
        Activity
      </div>
      <div className="p-4 flex flex-col h-[calc(100%-2.5rem)] space-y-3">
